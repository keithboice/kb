			...
			var e = {
						...
						class l extends r.BaseCommand {
							...
							async execute() {
								...
								if (this.all) s = new Set(t.workspaces);
									...
									s = new Set(
										this.workspaces.map((e) => t.getWorkspaceByIdent(a.structUtils.parseIdent(e)))
									);
								for (const e of s)
								...
								.shape({
									...
									workspaces: i
										...
										.when("all", {
											...
											then: i
												.array()
												.max(0, "Cannot specify workspaces when using the --all flag"),
											otherwise: i.array(),
										}),
								})),
						...
						class A extends r.BaseCommand {
							...
							async execute() {
								...
								const l = this.cli.process([this.commandName, ...this.args]),
									u =
										1 === l.path.length && "run" === l.path[0] && void 0 !== l.scriptName
											? l.scriptName
											: null;
								if (0 === l.path.length)
									...
									(!u || e.manifest.scripts.has(u) || u.includes(":")) &&
										((u === process.env.npm_lifecycle_event && e.cwd === o.cwd) ||
											...
											(this.exclude.length > 0 &&
												p().isMatch(a.structUtils.stringifyIdent(e.locator), this.exclude)) ||
											...
											for (const [e, t] of _) {
												...
												if (this.topological || this.topologicalDev) {
													...
													for (const t of e.values()) {
														...
														if (
															((a = null === e || !_.has(e.anchoredLocator.locatorHash)),
															!a)
														)
															break;
													}
							...
							let n = void 0 === t.rangeLimit ? 1e3 : t.rangeLimit,
								i = (e, l = {}) => {
									...
									if (e.nodes && e.ranges > 0) {
										...
										let l = o(...i, t);
										return (
											0 === l.length && (l = r(e, t)), p.push(s(p.pop(), l)), void (e.nodes = [])
										);
									}
					...
					425: (e, t, n) => {
						...
						e.exports = (e, t = {}) => {
							...
							if (e.length > m)
								throw new SyntaxError(`Input length (${e.length}), exceeds max characters (${m})`);
							let _,
								...
								return (
									...
									i(n)
										? i(e) && i(t)
											? g(e, t, n, r)
											: ((e, t, n = 1, o = {}) => {
													if ((!i(e) && e.length > 1) || (!i(t) && t.length > 1))
														return h(e, t, o);
								...
								for (let s = 0; s < t.length; s++) {
									...
									for (let t of e) {
										...
										(p ? !e.isMatch : e.isMatch) &&
											(p ? o.add(e.output) : (o.delete(e.output), r.add(e.output)));
									}
								}
					...
					974: (e, t, n) => {
						const o = n(86),
							...
							d = (e, t) => {
								...
								let f = e.length;
								if (f > d)
									throw new SyntaxError(`Input length: ${f}, exceeds maximum allowed length: ${d}`);
								...
								for (; !j(); ) {
									...
									if ("\\" === U) {
										...
										if (
											(t &&
												t[0].length > 2 &&
												((o = t[0].length), (B.index += o), o % 2 != 0 && (U += "\\")),
									...
									if ("]" === U) {
										...
										if (
											((B.output = B.output.slice(0, -G.value.length)), !0 === n.literalBrackets)
										) {
									...
									if ("+" === U) {
										...
										if (
											(G && ("bracket" === G.type || "paren" === G.type || "brace" === G.type)) ||
											B.parens > 0
										) {
											z({ type: "plus", value: U });
											continue;
									...
									!0 !== n.bash
										? !G || ("bracket" !== G.type && "paren" !== G.type) || !0 !== n.regex
											...
											: ((o.output = U), z(o))
										: ((o.output = ".*?"),
										  ("bos" !== G.type && "slash" !== G.type) || (o.output = $ + o.output),
										  z(o));
								}
								for (; B.brackets > 0; ) {
						...
						e.exports = (e, t) => {
							...
							for (; T < E; ) {
								...
								if (((S = F()), S !== s)) {
									...
									if (S !== p) {
										...
										if ((b.push(T), v.push(j), (j = { value: "", depth: 0, isGlob: !1 }), !0 === U))
											continue;
										if (w === l && T === k + 1) {
											k += 2;
											continue;
							...
							k > 0 && ((Q = H.slice(0, k)), (H = H.slice(k)), (L -= k)),
								...
								W &&
									...
									(W = W.slice(0, -1)),
								!0 === n.unescape &&
									(X && (X = o.removeBackslashes(X)), W && !0 === P && (W = o.removeBackslashes(W)));
							const q = {
								prefix: Q,
								input: e,
								start: k,
					...
					598: (e, t, n) => {
						...
						(t.isObject = (e) => null !== e && "object" == typeof e && !Array.isArray(e)),
							...
							(t.isWindows = (e) =>
								e && "boolean" == typeof e.windows ? e.windows : !0 === r || "\\" === o.sep),
							(t.escapeLast = (e, n, o) => {
					...
					615: (e, t, n) => {
						...
						function a(e, t, n) {
							...
							return (
								s && (a += !0 === n.shorthand ? "\\d" : "[0-9]"), { pattern: a, count: [s], digits: r }
							);
						}
						function s(e, t, n, o) {
							let r,
