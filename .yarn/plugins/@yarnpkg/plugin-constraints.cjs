...
***************************************************************************** */ function i(
							...
							var i,
								a = arguments.length,
								s = a < 3 ? r : null === n ? (n = Object.getOwnPropertyDescriptor(r, t)) : n;
							if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
								s = Reflect.decorate(e, r, t, n);
							else
								for (var o = e.length - 1; o >= 0; o--)
									(i = e[o]) && (s = (a < 3 ? i(s) : a > 3 ? i(r, t, s) : i(r, t)) || s);
						...
						var a = t(2594),
							...
							f = t(2184),
							d = t.n(f);
						const { is_atom: w, is_variable: h, is_instantiated_list: g } = c().type;
						function m(e, r, t) {
							e.prepend(t.map((e) => new (c().type.State)(r.goal.replace(e), r.substitution, r)));
						}
						const v = new WeakMap();
						function b(e) {
						...
						const x = new (c().type.Module)(
							"constraints",
							{
								"project_workspaces_by_descriptor/3": (e, r, t) => {
									const [i, a, s] = t.args;
									if (!w(i) || !w(a)) return void e.throwError(c().error.instantiation(t.indicator));
									...
									h(s) &&
										null !== l &&
										m(e, r, [
											new (c().type.Term)("=", [s, new (c().type.Term)(String(l.relativeCwd))]),
										]),
										w(s) && null !== l && l.relativeCwd === s.id && e.success(r);
								},
								"workspace_field/3": (e, r, t) => {
									const [n, i, a] = t.args;
									if (!w(n) || !w(i)) return void e.throwError(c().error.instantiation(t.indicator));
									const s = b(e).tryWorkspaceByCwd(n.id);
									if (null == s) return;
									const o = _()(s.manifest.raw, i.id);
									void 0 !== o &&
										m(e, r, [new (c().type.Term)("=", [a, new (c().type.Term)(String(o))])]);
								},
								...
								"workspace_field_test/4": (e, r, t) => {
									...
									if (void 0 === p) return;
									const l = { $$: p };
									for (const [e, r] of s.toJavaScript().entries()) l["$" + e] = r;
						...
						function k(e) {
							...
							try {
								r = (function e(r) {
										...
										switch (r.indicator) {
											...
											case "existence_error/2":
												return new n.ReportError(
													...
													`Existence error: ${e(r.args[0])} ${e(r.args[1])} not found`
												);
											case "line/1":
									...
									throw "couldn't pretty print because of unsupported node " + r;
								})(e);
							} catch (r) {
						...
						class P {
							constructor(e) {
								...
								o.xfs.existsSync(r) && (this.source = o.xfs.readFileSync(r, "utf8"));
							}
							...
							async genEnforcedDependencies(e) {
								...
								for await (const t of e.makeQuery(
									...
									const e = o.ppath.resolve(this.project.cwd, O(t.links.WorkspaceCwd)),
									...
									r.push({ workspace: p, dependencyIdent: l, dependencyRange: a, dependencyType: s });
								}
							...
							async *query(e) {
								...
								for await (const t of r.makeQuery(e)) {
									const e = {};
									for (const [r, n] of Object.entries(t.links)) "_" !== r && (e[r] = O(n));
									yield e;
								}
							}
						}
						...
						class I extends a.BaseCommand {
							...
							async execute() {
								const e = await n.Configuration.find(this.context.cwd, this.context.plugins),
									...
									await n.StreamReport.start(
										...
										async (e) => {
											for await (const r of t.query(i)) {
												...
												for (let r = 0; r < n; r++) {
													const [a, s] = t[r];
													e.reportInfo(null, `${R(r, n)}${a.padEnd(i, " ")} = ${N(s)}`);
												}
												e.reportJson(r);
											}
										}
						...
						function N(e) {
							return "string" != typeof e ? "" + e : e.match(/^[a-zA-Z][a-zA-Z0-9_]+$/) ? e : `'${e}'`;
						}
						function R(e, r) {
							const t = 0 === e,
								n = e === r - 1;
						...
						(I.usage = s.Command.Usage({
							...
							i([s.Command.Path("constraints", "query")], I.prototype, "execute", null);
						class A extends a.BaseCommand {
							...
							async execute() {
								const e = await n.Configuration.find(this.context.cwd, this.context.plugins),
									{ project: r } = await n.Project.find(e, this.context.cwd),
									t = await P.find(r);
								this.context.stdout.write(this.verbose ? t.fullSource : t.source);
							}
						}
						(A.usage = s.Command.Usage({
							...
							i([s.Command.Path("constraints", "source")], A.prototype, "execute", null);
						var $ = t(1534),
							M = t.n($),
							j = t(404),
							X = t.n(j);
								...
								const e = await n.Configuration.find(this.context.cwd, this.context.plugins),
									...
									i = await n.StreamReport.start(
										...
										async (r) => {
											...
											await Promise.all(
												[...n].map(async (e) => {
													e.manifest.load(e.manifest.raw), await e.persistManifest();
												})
											);
						...
						async function B(e, r, t, { configuration: i, fix: a }) {
							...
							for (const {
								...
								let p = a.get(i);
								void 0 === p && a.set(i, (p = new Set())), s.set(r.identHash, r), p.add(n);
							}
							for (const [t, p] of o)
								for (const [o, l] of p) {
									const p = s.get(o);
										...
										if (l.length > 2)
											...
											r.push([
												...
												`${n.structUtils.prettyWorkspace(
													...
													i,
													String(l[0])
												)} and ${n.structUtils.prettyRange(i, String(l[1]))} (in ${s})`,
											]);
										else {
													...
													? o.range !== u &&
													  (a
															? (t.manifest[s].set(
															  ...
															  e.add(t))
															: r.push([
																	n.MessageName.CONSTRAINTS_INCOMPATIBLE_DEPENDENCY,
																	`${n.structUtils.prettyWorkspace(
																		i,
																		t
																	)} must depend on ${n.structUtils.prettyIdent(
									...
									if (o.length > 2)
										r.push([
											...
											`${n.structUtils.prettyWorkspace(
												...
												.slice(0, -1)
												.map((e) => n.formatUtils.pretty(i, String(e), "magenta"))
										...
										r.push([
											...
											`${n.structUtils.prettyWorkspace(
												...
												String(o[0]),
												"magenta"
											)} or ${n.formatUtils.pretty(i, String(o[1]), "magenta")}`,
										]);
									else {
											  ...
											  (a
													...
													: r.push([
															...
															`${n.structUtils.prettyWorkspace(
																...
																s,
																"cyan"
															)} set to ${n.formatUtils.pretty(i, String(l), "magenta")}`,
													  ]));
									}
								}
						}
						async function U(e, r, t) {
							null === t ? X()(e.manifest.raw, r) : M()(e.manifest.raw, r, JSON.parse(t));
						}
					...
					5759: (e, r, t) => {
						...
						e.exports = function (e, r, t) {
							var s = e[r];
							(a.call(e, r) && i(s, t) && (void 0 !== t || r in e)) || n(e, r, t);
						};
					},
					9836: (e, r, t) => {
						var n = t(1074);
					...
					4173: (e, r, t) => {
						var n = t(6725),
							i = t(9874);
						e.exports = function (e, r) {
							for (var t = 0, a = (r = n(r, e)).length; null != e && t < a; ) e = e[i(r[t++])];
					...
					624: (e, r, t) => {
						...
						e.exports = function (e, r, t, p) {
							if (!s(e)) return e;
							for (var l = -1, u = (r = i(r, e)).length, c = u - 1, y = e; null != y && ++l < u; ) {
								var _ = o(r[l]),
									f = t;
								if (l != c) {
									var d = y[_];
									void 0 === (f = p ? p(d, _, y) : void 0) && (f = s(d) ? d : a(r[l + 1]) ? [] : {});
								}
								n(y, _, f), (y = y[_]);
							}
							return e;
					...
					474: (e, r, t) => {
						...
						e.exports = function (e, r) {
							...
							var t = typeof e;
							return (
								!("number" != t && "symbol" != t && "boolean" != t && null != e && !i(e)) ||
								s.test(e) ||
								!a.test(e) ||
					...
					6931: (e, r, t) => {
						...
						var n,
							...
							u = "The current environment doesn't support interactive reading from TTY.",
							c = t(5747),
						...
						function k(e) {
							...
							if (
								(a ||
									(l
										? process.env.PSModulePath
											? ((a = "powershell.exe"),
											  (s = ["-ExecutionPolicy", "Bypass", "-File", __dirname + "\\read.ps1"]))
											: ((a = "cscript.exe"), (s = ["//nologo", __dirname + "\\read.cs.js"]))
								...
								i = (function (e, r) {
									...
									var i,
										...
										O = t(6417);
									(w = O.createHash("sha256")).update("" + process.pid + g++ + Math.random()),
										(m = w.digest("hex")),
									...
									for (; "1" !== c.readFileSync(S, { encoding: e.encoding }).trim(); );
									return (
										"0" === (y = c.readFileSync(k, { encoding: e.encoding }).trim())
											? (v.input =
													h.update(
							...
							return i.error || ((i.input = i.input.replace(/^\s*'|'\s*$/g, "")), (e.display = "")), i;
						}
						function S(e) {
							var r = "",
								t = e.display,
							...
							return (
								...
								(function () {
									...
									function a() {
										return (
											e || ((e = process.binding("fs")), (r = process.binding("constants"))), e
										);
									}
									if ("string" == typeof w)
										if (((w = null), l)) {
											if (
												((t = (function (e) {
													var r = process.version.replace(/^\D+/, "").split("."),
														t = 0;
													return (
														(r[0] = +r[0]) && (t += 1e4 * r[0]),
														(r[1] = +r[1]) && (t += 100 * r[1]),
												...
												try {
													(w = a().open("CONIN$", r.O_RDWR, parseInt("0666", 8))),
														(i = new y(w, !0));
												} catch (e) {}
											else
												process.stdin.pause(),
											...
											if (process.stdout.isTTY) n = process.stdout.fd;
												...
												if ("number" != typeof n)
													try {
														n = a().open("CONOUT$", r.O_RDWR, parseInt("0666", 8));
													} catch (e) {}
											}
										} else {
											if (process.stdin.isTTY) {
												process.stdin.pause();
												try {
													(w = c.openSync("/dev/tty", "r")), (i = process.stdin._handle);
												} catch (e) {}
											} else
												try {
								...
								(function () {
									...
									if (((p = ""), !b && i && ("number" == typeof n || (!e.display && d)))) {
										if (
											(e.display && (c.writeSync(n, e.display), (e.display = "")), !e.displayOnly)
										)
											if (g(!d)) {
												for (
													...
													if (
														...
														_ &&
															"string" ==
																typeof (f = (_.match(/^(.*?)[\r\n]/) || [])[1]) &&
															((_ = f), (t = !0)),
														_ && (_ = _.replace(/[\x00-\x08\x0b\x0c\x0e-\x1f\x7f]/g, "")),
														_ && o && (_ = _.replace(o, "")),
														_ &&
															(d ||
																(e.hideEchoBack
								...
								e.print &&
									...
									e.print(
										t +
											(e.displayOnly
												? ""
												: (e.hideEchoBack ? new Array(r.length + 1).join(e.mask) : r) + "\n"),
										e.encoding
									),
								e.displayOnly ? "" : (m = e.keepWhitespace || e.keyIn ? r : r.trim())
							);
						}
						function O(e, r) {
							var t = [];
							return (
								(function e(n) {
									null != n && (Array.isArray(n) ? n.forEach(e) : (r && !r(n)) || t.push(n));
								})(e),
								t
							);
						}
						...
						function N(e, r) {
							...
							function a(e, t, n, i, a, s) {
								var o;
								return t || "string" != typeof (o = r(a)) ? n : o ? (i || "") + o + (s || "") : "";
							}
						...
						function $(e, r) {
							var t,
								...
								i,
								a = {};
							if ((r.phContent && (t = r.phContent(e, r)), "string" != typeof t))
								switch (e) {
									case "hideEchoBack":
									case "mask":
									case "defaultInput":
									...
									case "limitCountNotZero":
										t =
											(t = r[r.hasOwnProperty("limitSrc") ? "limitSrc" : "limit"].length) ||
											"limitCountNotZero" !== e
												? t + ""
												: "";
										break;
									...
									case "cwdHome":
										(t = process.cwd()),
											"CWD" === e ? (t = f.basename(t)) : "cwdHome" === e && (t = I(t));
										break;
									case "date":
									case "time":
									case "localeDate":
						...
						function M(e) {
							...
							if (!a) return null;
							for (
								i = (r = a[1].charCodeAt(0)) < (t = a[2].charCodeAt(0)) ? 1 : -1, n = r;
								n !== t + i;
								n += i
							)
						...
						function j(e) {
							...
							for (e = e.trim(); (r = n.exec(e)); )
								(t = r[3] || r[4] || ""), r[1] && (a.push(i), (i = "")), (i += t);
							return i && a.push(i), a;
						}
						function X(e, r) {
							return (
								!(!r.trueValue.length || !C(e, r.trueValue, r.caseSensitive)) ||
								((!r.falseValue.length || !C(e, r.falseValue, r.caseSensitive)) && e)
							);
						}
						function D(e) {
							var r, t, n, i, a, s, o;
							...
							for (
								...
								if (
									(!t && e.preCheck && ((r = (o = e.preCheck(r, e)).res), o.forceNext && (t = !0)),
									!t)
								) {
									if (!e.limitSrc.length || C(r, e.limitSrc, e.caseSensitive)) break;
								...
								"object" == typeof e
									? (Object.keys(e).forEach(function (t) {
									  ...
									  n.hasOwnProperty("_") ||
											(t.limit = function () {
												var e = t.args[0] || "";
												return r.caseSensitive || (e = e.toLowerCase()), n.hasOwnProperty(e);
											}))
						...
						function U(e, t, n) {
							...
							return (
								...
								(t && !1 === t.guide) || !(e += "") || (e = e.replace(/\s*:?\s*$/, "") + " [y/n]: "),
								"boolean" ==
								typeof (i = r.keyIn(
									e,
									P(t, {
						...
						function F(e, t) {
							var n;
							return t.length && ((n = {})[e] = t[0]), r.setDefaultOptions(n)[e];
						}
						(r._DBG_set_useExt = function (e) {
							...
							(r.keyIn = function (e, r) {
								var t = P(P(!0, r), { display: e, keyIn: !0, keepWhitespace: !0 });
								return (
									(t.limitSrc = t.limit
										.filter(function (e) {
											var r = typeof e;
							...
							(r.questionNewPassword = function (e, t) {
								...
								for (
									s = N((t = t || {}).charlist ? t.charlist + "" : "$<!-~>", M),
										(isNaN((i = parseInt(t.min, 10))) || "number" != typeof i) && (i = 12),
										(isNaN((a = parseInt(t.max, 10))) || "number" != typeof a) && (a = 24),
										l = new RegExp("^[" + E(s) + "]{" + i + "," + a + "}$"),
										(n = R([s], _.caseSensitive, !0)).text = A(n.values, n.suppressed),
										o =
											...
											limit: function (e) {
													...
													e.split(/\/|\\/).reduce(function (e, r) {
														...
														if (c.existsSync(t)) {
															if (!c.statSync(t).isDirectory())
																throw new Error("Non directory already exists: " + t);
														} else c.mkdirSync(t);
														return e;
													}, "");
												}
												...
												try {
													if (
														...
														return (
															(i =
																(r ? "Already exists" : "No such file or directory") +
																": " +
																n),
															!1
														);
													if (
														(!r &&
															...
															(t.isDirectory
																? o(n)
																: (o(f.dirname(n)), c.closeSync(c.openSync(n, "w"))),
															(n = c.realpathSync(n))),
														...
														if ((t.min && a.size < +t.min) || (t.max && a.size > +t.max))
															return (
																(i = "Size " + a.size + " is out of range: " + n), !1
															);
													}
													if ("function" == typeof t.validate && !0 !== (s = t.validate(n)))
							...
							(r.promptCL = function (e, t) {
								var n = P(
									...
									i = q(e, n);
								return (n.limit = i.limit), (n.preCheck = i.preCheck), r.prompt(n), i.args;
							}),
							...
							(r.promptCLLoop = function (e, t) {
								var n = P(
									...
									i = q(e, n);
								for (n.limit = i.limit, n.preCheck = i.preCheck; r.prompt(n), !i.hRes; );
							}),
							...
							(r.keyInSelect = function (e, t, n) {
								...
								return (
									...
									(t += "") &&
										((n && !1 === n.guide) || (t = t.replace(/\s*:?\s*$/, "") + " [$<limit>]: "),
										(p += t)),
						...
						!(function () {
							...
							(tau_file_system = {
									...
									if (!n) {
										...
										(n = {
											...
											put_byte: function (e, r) {
												var t = "end_of_stream" === r ? this.text.length : Math.floor(r / 2);
												if (this.text.length < t) return null;
												var n =
													this.text.length === t ? -1 : s(this.text[Math.floor(r / 2)], 0);
												return (
													(n =
														r % 2 == 0
								...
								(nodejs_user_input = {
									buffer: "",
									get: function (e, r) {
										for (var n, i = t(6931); nodejs_user_input.buffer.length < e; )
											nodejs_user_input.buffer += i.question();
										return (
											(n = nodejs_user_input.buffer.substr(0, e)),
											(nodejs_user_input.buffer = nodejs_user_input.buffer.substr(e)),
											n
										);
									},
								}),
								...
								(r = Array.prototype.indexOf
									...
									: function (e, r) {
											for (var t = e.length, n = 0; n < t; n++) if (r === e[n]) return n;
											return -1;
									  });
							var i,
								a,
								...
								p = function (e, r) {
									if (0 !== e.length) {
										for (var t = e[0], n = e.length, i = 1; i < n; i++) t = r(t, e[i]);
										return t;
									}
								};
							(i = Array.prototype.map
								...
								: function (e, r) {
										for (var t = [], n = e.length, i = 0; i < n; i++) t.push(r(e[i]));
										return t;
								  }),
								(a = Array.prototype.filter
									...
									: function (e, r) {
											for (var t = [], n = e.length, i = 0; i < n; i++) r(e[i]) && t.push(e[i]);
											return t;
									  }),
							...
							function y(e) {
								...
								switch (e.substr(0, 2).toLowerCase()) {
									...
									case "0'":
										...
										(t = []),
										(n = !1),
										r.replace(l, function (e, r, i, a, o, p, l, c, y, _, f, d, w, h, g, m, v) {
											switch (!0) {
												case void 0 !== y:
							...
							function d(e, r, t, n, i) {
								if (!r[t])
									return { type: 0, value: A.error.syntax(r[t - 1], "expression expected", !0) };
								if ("0" === n) {
									switch ((c = r[t]).name) {
										case "number":
											return { type: 1, len: t + 1, value: new A.type.Num(c.value, c.float) };
										case "variable":
											return { type: 1, len: t + 1, value: new A.type.Var(c.value) };
										case "string":
											var a;
											switch (e.get_flag("double_quotes").id) {
												...
												case "codes":
													...
													for (var o = c.value.length - 1; o >= 0; o--)
														a = new k(".", [new A.type.Num(s(c.value, o), !1), a]);
													break;
												case "chars":
													a = new k("[]", []);
													for (o = c.value.length - 1; o >= 0; o--)
														a = new k(".", [new A.type.Term(c.value.charAt(o), []), a]);
											}
											return { type: 1, len: t + 1, value: a };
										case "l_paren":
											return 1 !== (y = d(e, r, t + 1, e.__get_max_priority(), !0)).type
												? y
									...
									var p = (function (e, r, t, n) {
										if (
											...
											("atom" === r[t].name &&
												"." === r[t].raw &&
												!n &&
												(r[t].space || !r[t + 1] || "l_paren" !== r[t + 1].name))
										)
											return {
												type: 0,
												derived: !1,
										...
										if ("atom" === r[t].name && "," !== r[t].raw) {
											if ((t++, r[t - 1].space))
												return { type: 1, len: t, value: new A.type.Term(i.value, a) };
											if (r[t] && "l_paren" === r[t].name) {
												if (r[t + 1] && "r_paren" === r[t + 1].name)
													return {
														type: 0,
														derived: !0,
														value: A.error.syntax(r[t + 1], "argument expected"),
													};
												var s = d(e, r, ++t, "999", !0);
												if (0 === s.type)
													return s.derived
										...
										return { type: 0, derived: !1, value: A.error.syntax(r[t], "term expected") };
									})(e, r, t, i);
									return 1 === p.type ||
										p.derived ||
										1 ===
												...
												if (r[t] && "l_brace" === r[t].name) {
													...
													if (0 === n.type)
														return r[t] && "r_brace" === r[t].name
															? { type: 1, len: t + 1, value: new A.type.Term("[]", []) }
															: {
																	type: 0,
																	derived: !0,
													...
													var s = !1;
													if (r[t] && "bar" === r[t].name) {
														if (((s = !0), 0 === (n = d(e, r, t + 1, "999", !0)).type))
															return n.derived
																? n
																: {
																		type: 0,
										...
										p.derived
										? p
										: { type: 0, derived: !1, value: A.error.syntax(r[t], "unexpected token") };
								}
								e.__get_max_priority();
								var l = e.__get_next_priority(n),
									u = t;
								if ("atom" === r[t].name && r[t + 1] && (r[t].space || "l_paren" !== r[t + 1].name)) {
									var c = r[t++];
									if ((w = e.__lookup_operator_classes(n, c.value)) && w.indexOf("fy") > -1) {
										if (0 !== (y = d(e, r, t, n, i)).type)
											return "-" === c.value && !c.space && A.type.is_number(y.value)
												? {
														value: new A.type.Num(-y.value.value, y.value.is_float),
														len: y.len,
														type: 1,
												  }
												: { value: new A.type.Term(c.value, [y.value]), len: y.len, type: 1 };
										y;
									} else if (w && w.indexOf("fx") > -1) {
										var y;
										if (0 !== (y = d(e, r, t, l, i)).type)
											return { value: new A.type.Term(c.value, [y.value]), len: y.len, type: 1 };
										y;
									}
								}
								if (1 === (y = d(e, r, (t = u), l, i)).type) {
									...
									if (
										r[t] &&
										(("atom" === r[t].name && e.__lookup_operator_classes(n, c.value)) ||
											("bar" === r[t].name && e.__lookup_operator_classes(n, "|")))
									) {
										var _ = l,
											f = n;
										if ((w = e.__lookup_operator_classes(n, c.value)).indexOf("xf") > -1)
											return {
										...
										if (0 !== y.type)
											for (;;) {
												...
												if (
													...
													break;
												if ((w = e.__lookup_operator_classes(n, c.value)).indexOf("yf") > -1)
													y = {
														value: new A.type.Term(c.value, [y.value]),
														len: ++t,
														type: 1,
													...
													var h;
													if (0 === (h = d(e, r, ++t, _, i)).type) return (h.derived = !0), h;
													(t = h.len),
														(y = {
															value: new A.type.Term(c.value, [y.value, h.value]),
															len: t,
									...
									} else ({ type: 0, value: A.error.syntax(r[y.len - 1], "operator expected") });
									return y;
								}
								return y;
							}
							function w(e, r, t) {
								var n,
									...
									s = null;
								if (0 !== a.type) {
									if (r[(t = a.len)] && "atom" === r[t].name && "." === r[t].raw) {
										if ((t++, A.type.is_term(a.value))) {
											if (
												(":-/2" === a.value.indicator
													...
													? (((s = (function (e, r) {
															...
															var t = r.next_free_variable(),
																n = (function e(r, t, n) {
																	var i;
																	if (A.type.is_term(r) && "!/0" === r.indicator)
																		return { value: r, variable: t, error: !1 };
																	if (A.type.is_term(r) && ",/2" === r.indicator) {
																	...
																	if (A.type.is_term(r) && "{}/1" === r.indicator)
																		return {
																			value: r.args[0],
																			variable: t,
																			error: !1,
															...
															return n.error
																? n.value
																: ((e.body = n.value),
																  (e.head.args = e.head.args.concat([t, n.variable])),
													  ...
													  (n = { value: s, len: t, type: A.type.is_rule(s) ? 1 : 0 }))
													: (n = {
												...
												o.length > 0 &&
													e.throw_warning(A.warning.singleton(o, s.head.indicator, i));
											}
											return n;
										}
										return { type: 0, value: A.error.syntax(r[t], "callable expected") };
									}
									return {
										type: 0,
										value: A.error.syntax(r[t] ? r[t] : r[t - 1], ". or operator expected"),
									};
								}
								return a;
							}
							function h(e) {
								return A.type.is_variable(e)
									? new k("call", [e])
									: A.type.is_term(e) && -1 !== [",/2", ";/2", "->/2"].indexOf(e.indicator)
									? new k(e.id, [h(e.args[0]), h(e.args[1])])
									: e;
							}
							function g(e, r) {
								for (var t = r || new A.type.Term("[]", []), n = e.length - 1; n >= 0; n--)
							...
							function v(e) {
								return function (r, t, n) {
									var i = n.args[0],
										a = n.args.slice(1, e);
									if (A.type.is_variable(i)) r.throw_error(A.error.instantiation(r.level));
										...
										if (null === /^\n/.exec(r)) {
											...
											if (!s.length)
												return this.set_last_tokens([
													{ value: r, matches: [], name: "lexical", line: n, start: i },
												]);
											var f;
											switch (
												(((f = p(s, function (e, r) {
												...
												case "atom":
													(f.raw = f.value),
														"'" === f.value.charAt(0) &&
															((f.value = c(f.value.substr(1, f.value.length - 2), "'")),
															null === f.value &&
																((f.name = "lexical"),
												...
												case "string":
													...
													(f.value = c(f.value.substr(1, f.value.length - 2), d)),
														null === f.value &&
															((f.name = "lexical"),
															(f.value = "unknown escape sequence"));
													break;
							...
							function O(e, r, t, n, i, a) {
								(this.id = S++),
									...
									(this.position = "append" === this.mode ? "end_of_stream" : 0),
									(this.output = "write" === this.mode || "append" === this.mode),
							...
							function I(r) {
								(r = void 0 === r || r <= 0 ? 1e3 : r),
									...
									(this.file_system = e.exports ? nodejs_file_system : tau_file_system),
									...
									(this.flag = {
										...
										integer_rounding_function: A.flag.integer_rounding_function.value,
							...
							function R(e, r, t) {
								(this.id = e), (this.rules = r), (this.exports = t), (A.module[e] = this);
							}
							(R.prototype.exports_predicate = function (e) {
								return -1 !== this.exports.indexOf(e);
							}),
								(x.prototype.unify = function (e, t) {
									if (t && -1 !== r(e.variables(), this.id) && !A.type.is_variable(e)) return null;
									var n = {};
									return (n[this.id] = e), new E(n);
								}),
								(T.prototype.unify = function (e, r) {
									return A.type.is_number(e) && this.value === e.value && this.is_float === e.is_float
										? new E()
										: null;
								}),
								(k.prototype.unify = function (e, r) {
									if (A.type.is_term(e) && this.indicator === e.indicator) {
										for (var t = new E(), n = 0; n < this.args.length; n++) {
											var i = A.unify(this.args[n].apply(t), e.args[n].apply(t), r);
								...
								(O.prototype.unify = function (e, r) {
									return A.type.is_stream(e) && this.id === e.id ? new E() : null;
								}),
								...
								(k.prototype.toString = function (e, r, t) {
									if (
										...
										var n = this.args[0].value,
											a = Math.floor(n / 26);
										return "ABCDEFGHIJKLMNOPQRSTUVWXYZ"[n % 26] + (0 !== a ? a : "");
									}
									switch (this.indicator) {
										...
										case "./2":
											for (
												var s = "[" + this.args[0].toString(e), o = this.args[1];
												"./2" === o.indicator;

											)
												(s += ", " + o.args[0].toString(e)), (o = o.args[1]);
											return "[]/0" !== o.indicator && (s += "|" + o.toString(e)), (s += "]");
										case ",/2":
											return (
												"(" + this.args[0].toString(e) + ", " + this.args[1].toString(e) + ")"
											);
										default:
											var p = this.id,
												l = e.session
											...
											var u =
												...
												(l.priority === r.priority &&
													(("xfy" === l.class && this.indicator !== r.indicator) ||
														("yfx" === l.class && this.indicator !== r.indicator) ||
								...
								(E.prototype.toString = function (e) {
									...
									for (var t in this.links)
										this.links.hasOwnProperty(t) &&
											("{" !== r && (r += ", "), (r += t + "/" + this.links[t].toString(e)));
									return (r += "}");
								}),
								(P.prototype.toString = function (e) {
									return null === this.goal
										? "<" + this.substitution.toString(e) + ">"
										: "<" + this.goal.toString(e) + ", " + this.substitution.toString(e) + ">";
								}),
								(C.prototype.toString = function (e) {
									return this.body
										? this.head.toString(e) + " :- " + this.body.toString(e) + "."
								...
								(E.prototype.clone = function () {
									...
									for (var r in this.links)
										this.links.hasOwnProperty(r) && (e[r] = this.links[r].clone());
									return new E(e);
								}),
								(P.prototype.clone = function () {
									return new P(this.goal.clone(), this.substitution.clone(), this.parent);
								}),
								(C.prototype.clone = function () {
									return new C(this.head.clone(), null !== this.body ? this.body.clone() : null);
								}),
								...
								(T.prototype.equals = function (e) {
									return (
										A.type.is_number(e) && this.value === e.value && this.is_float === e.is_float
									);
								}),
								(k.prototype.equals = function (e) {
									if (!A.type.is_term(e) || this.indicator !== e.indicator) return !1;
								...
								(E.prototype.equals = function (e) {
									...
									for (r in this.links)
										if (
											...
											return !1;
									for (r in e.links) if (e.links.hasOwnProperty(r) && !this.links[r]) return !1;
									return !0;
								}),
								...
								(C.prototype.rename = function (e) {
									return new C(this.head.rename(e), null !== this.body ? this.body.rename(e) : null);
								}),
								...
								(C.prototype.apply = function (e) {
									return new C(this.head.apply(e), null !== this.body ? this.body.apply(e) : null);
								}),
								(E.prototype.apply = function (e) {
									var r,
										t = {};
									for (r in this.links)
										this.links.hasOwnProperty(r) && (t[r] = this.links[r].apply(e));
									return new E(t);
								}),
								...
								(k.prototype.search = function (e) {
									if (A.type.is_term(e) && void 0 !== e.ref && this.ref === e.ref) return !0;
									for (var r = 0; r < this.args.length; r++)
										if (A.type.is_term(this.args[r]) && this.args[r].search(e)) return !0;
									return !1;
								}),
								...
								(N.prototype.parse = function (e) {
									...
									return n.len === t.length && { value: n.value, expr: n, tokens: t };
								}),
								...
								(I.prototype.add_rule = function (e, r) {
									return (
										...
										this.rules[e.head.indicator] || (this.rules[e.head.indicator] = []),
								...
								(N.prototype.run_directive = function (e) {
									return !!A.type.is_directive(e) && (A.directive[e.indicator](this, e), !0);
								}),
									...
									for (var t in this.__operators)
										if (this.__operators[t][e])
											for (var n = 0; n < this.__operators[t][e].length; n++)
												if (0 === r || this.__operators[t][e][n].length === r + 1)
													return { priority: t, class: this.__operators[t][e][n] };
									return null;
								}),
								...
								(N.prototype.add_goal = function (e, r, t) {
									...
									for (var n = e.variables(), i = {}, a = 0; a < n.length; a++) i[n[a]] = new x(n[a]);
								...
								(N.prototype.consult = function (e, r) {
									...
									if ("string" == typeof e) {
										var n = (t = e).length;
										if (".pl" === t.substring(n - 3, n) && document.getElementById(t)) {
									...
									return (
										...
										(function (e, r, t) {
											...
											for (var o = 0, p = i.get_tokens(o); ; ) {
												...
												if (null === l.value.body && "?-/1" === l.value.head.indicator) {
													...
													u.add_goal(l.value.head.args[0]),
														...
														(o = l.len);
													var c = !0;
												} else if (null === l.value.body && ":-/1" === l.value.head.indicator) {
													c = e.run_directive(l.value.head.args[0]);
													(o = l.len),
														"char_conversion/2" === l.value.head.args[0].indicator &&
										...
										(function (e, r) {
											...
											for (var n = 0; ; ) {
												...
												if (!i[s] || "atom" !== i[s].name || "." !== i[s].raw) {
													var o = i[s];
													return new k("throw", [
														A.error.syntax(o || i[s - 1], ". or operator expected", !o),
													]);
												}
								...
								(N.prototype.get_free_variable = function (e) {
									var t = [];
									if ("_" === e.id || void 0 === this.session.renamed_variables[e.id]) {
										for (
											this.session.rename++,
												this.points.length > 0 && (t = this.head_point().substitution.domain());
											-1 !== r(t, A.format_variable(this.session.rename));

										)
											this.session.rename++;
										if ("_" === e.id) return new x(A.format_variable(this.session.rename));
										this.session.renamed_variables[e.id] = A.format_variable(this.session.rename);
									}
								...
								(N.prototype.next_free_variable = function () {
									...
									var e = [];
									for (
										this.points.length > 0 && (e = this.head_point().substitution.domain());
								...
								(I.prototype.is_public_predicate = function (e) {
									return (
										!this.public_predicates.hasOwnProperty(e) || !0 === this.public_predicates[e]
									);
								}),
								...
								(N.prototype.prepend = function (e) {
									for (var r = e.length - 1; r >= 0; r--) this.points.push(e[r]);
								}),
								...
								(N.prototype.success = function (e, r) {
									r = void 0 === r ? e : r;
									this.prepend([new P(e.goal.replace(null), e.substitution, r)]);
								}),
								(I.prototype.throw_error = function (e) {
									return this.thread.throw_error(e);
								}),
								(N.prototype.throw_error = function (e) {
									this.prepend([new P(new k("throw", [e]), new E(), null, null)]);
								}),
								...
								(N.prototype.step_rule = function (e, t) {
									var n = t.indicator;
									if (
										("user" === e && (e = null), null === e && this.session.rules.hasOwnProperty(n))
									)
									...
									for (
										...
										if (
											...
											(s.rules.hasOwnProperty(this.level) || s.exports_predicate(n))
										)
								...
								(N.prototype.step = function () {
									if (0 !== this.points.length) {
										var e = !1,
											r = this.points.pop();
										if ((this.debugger && this.debugger_states.push(r), A.type.is_term(r.goal))) {
											var t = r.goal.select(),
												n = null,
												i = [];
											if (null !== t) {
												this.total_steps++;
												for (var a = r; null !== a.parent && a.parent.goal.search(t); )
													a = a.parent;
												if (
													((this.level =
														null === a.parent
											...
											A.type.is_variable(r.goal)
												...
												: this.throw_error(A.error.type("callable", r.goal, this.level));
										return e;
									}
								}),
								...
								(N.prototype.again = function (e) {
									for (var r, t = Date.now(); this.__calls.length > 0; ) {
										for (
											this.warnings = [], !1 !== e && (this.current_limit = this.session.limit);
										...
										var n = Date.now();
										(this.cpu_time_last = n - t), (this.cpu_time += this.cpu_time_last);
										...
										this.current_limit <= 0
											...
											? ((r = this.session.format_error(this.points.pop())),
											  (this.points = []),
											  i(r))
											: (this.debugger && this.debugger_states.push(this.head_point()),
											  i((r = this.session.format_success(this.points.pop()))));
									}
								}),
								(I.prototype.unfold = function (e) {
									...
									for (var o = a.points.length - 1; o >= 0; o--) {
										var p = a.points[o],
											...
											u = n.replace(p.goal);
										null !== u && (u = u.apply(p.substitution)), s.push(new C(l, u));
									}
									var c = this.rules[t.indicator],
										y = r(c, e);
									return s.length > 0 && -1 !== y && (c.splice.apply(c, [y, 1].concat(s)), !0);
								}),
								...
								(E.prototype.exclude = function (e) {
									...
									for (var n in this.links)
										this.links.hasOwnProperty(n) && -1 === r(e, n) && (t[n] = this.links[n]);
									return new E(t);
								}),
								...
								(k.prototype.toJavaScript = function () {
									if (0 === this.args.length && "[]/0" !== this.indicator) return this.id;
								...
								(C.prototype.singleton_variables = function () {
									...
									for (var n = 0; n < e.length; n++) void 0 === r[e[n]] && (r[e[n]] = 0), r[e[n]]++;
							...
							var A = {
								...
								fromJavaScript: {
									...
									conversion: {
										...
										list: function (e) {
											for (var r, t = [], n = 0; n < e.length; n++) {
												if (void 0 === (r = A.fromJavaScript.apply(e[n]))) return;
												t.push(r);
											}
											return g(t);
										},
								...
								type: {
									...
									is_atomic: function (e) {
										return (e instanceof k && 0 === e.args.length) || e instanceof T;
									},
									is_compound: function (e) {
										return e instanceof k && e.args.length > 0;
									},
									is_list: function (e) {
										return e instanceof k && ("[]/0" === e.indicator || "./2" === e.indicator);
									},
									...
									is_fully_list: function (e) {
										for (; e instanceof k && "./2" === e.indicator; ) e = e.args[1];
										return e instanceof x || (e instanceof k && "[]/0" === e.indicator);
									},
									...
									is_character: function (e) {
										return (
											e instanceof k &&
											(1 === e.id.length ||
												(e.id.length > 0 && e.id.length <= 2 && s(e.id, 0) >= 65536))
										);
									},
									is_character_code: function (e) {
										return e instanceof T && !e.is_float && e.value >= 0 && e.value <= 1114111;
									},
									is_byte: function (e) {
										return e instanceof T && !e.is_float && e.value >= 0 && e.value <= 255;
									},
									is_operator: function (e) {
										return e instanceof k && A.arithmetic.evaluation[e.indicator];
									},
									is_directive: function (e) {
										return e instanceof k && void 0 !== A.directive[e.indicator];
									},
									is_builtin: function (e) {
										return e instanceof k && void 0 !== A.predicate[e.indicator];
									},
									is_error: function (e) {
									...
									is_flag: function (e) {
										return e instanceof k && 0 === e.args.length && void 0 !== A.flag[e.id];
									},
									...
									is_io_mode: function (e) {
										return A.type.is_atom(e) && -1 !== ["read", "write", "append"].indexOf(e.id);
									},
									is_stream_option: function (e) {
										return (
											A.type.is_term(e) &&
											(("alias/1" === e.indicator && A.type.is_atom(e.args[0])) ||
												("reposition/1" === e.indicator &&
													A.type.is_atom(e.args[0]) &&
													("true" === e.args[0].id || "false" === e.args[0].id)) ||
												("type/1" === e.indicator &&
													A.type.is_atom(e.args[0]) &&
													("text" === e.args[0].id || "binary" === e.args[0].id)) ||
									...
									is_stream_position: function (e) {
										return (
											...
											(A.type.is_atom(e) &&
												("end_of_stream" === e.id || "past_end_of_stream" === e.id))
										);
									},
									is_stream_property: function (e) {
										return (
											...
											("input/0" === e.indicator ||
												...
												("alias/1" === e.indicator &&
													(A.type.is_variable(e.args[0]) || A.type.is_atom(e.args[0]))) ||
									...
									is_read_option: function (e) {
										return (
											A.type.is_term(e) &&
											-1 !==
												["variables/1", "variable_names/1", "singletons/1"].indexOf(e.indicator)
										);
									},
									...
									evaluation: {
										...
										"//2": {
											...
											fn: function (e, r, t) {
												return r
													? e / r
													: A.error.evaluation("zero_division", t.__call_indicator);
											},
										},
										"///2": {
											type_args: !1,
								...
								directive: {
									"dynamic/1": function (e, r) {
										var t = r.args[0];
										if (A.type.is_variable(t)) e.throw_error(A.error.instantiation(r.indicator));
										else if (A.type.is_compound(t) && "//2" === t.indicator)
											if (A.type.is_variable(t.args[0]) || A.type.is_variable(t.args[1]))
												e.throw_error(A.error.instantiation(r.indicator));
											else if (A.type.is_atom(t.args[0]))
												if (A.type.is_integer(t.args[1])) {
													var n = r.args[0].args[0].id + "/" + r.args[0].args[1].value;
													(e.session.public_predicates[n] = !0),
														e.session.rules[n] || (e.session.rules[n] = []);
												} else e.throw_error(A.error.type("integer", t.args[1], r.indicator));
											else e.throw_error(A.error.type("atom", t.args[0], r.indicator));
										else e.throw_error(A.error.type("predicate_indicator", t, r.indicator));
									},
									"multifile/1": function (e, r) {
										...
										A.type.is_variable(t)
											...
											? A.type.is_variable(t.args[0]) || A.type.is_variable(t.args[1])
												? e.throw_error(A.error.instantiation(r.indicator))
												: A.type.is_atom(t.args[0])
												? A.type.is_integer(t.args[1])
													? (e.session.multifile_predicates[
															r.args[0].args[0].id + "/" + r.args[0].args[1].value
													  ] = !0)
													: e.throw_error(A.error.type("integer", t.args[1], r.indicator))
												: e.throw_error(A.error.type("atom", t.args[0], r.indicator))
											: e.throw_error(A.error.type("predicate_indicator", t, r.indicator));
									},
											...
											? A.type.is_flag(t)
												? A.type.is_value_flag(t, n)
													? A.type.is_modifiable_flag(t)
														...
														: e.throw_error(A.error.permission("modify", "flag", t))
													: e.throw_error(
															A.error.domain(
																"flag_value",
																new k("+", [t, n]),
												...
												: e.throw_error(A.error.domain("prolog_flag", t, r.indicator))
											: e.throw_error(A.error.type("atom", t, r.indicator));
									},
									"use_module/1": function (e, t) {
										var n = t.args[0];
										if (A.type.is_variable(n)) e.throw_error(A.error.instantiation(t.indicator));
										else if (A.type.is_term(n)) {
											if (A.type.is_module(n)) {
												var i = n.args[0].id;
												-1 === r(e.session.modules, i) && e.session.modules.push(i);
											}
									...
									"char_conversion/2": function (e, r) {
										...
										A.type.is_variable(t) || A.type.is_variable(n)
											...
											? A.type.is_character(n)
												...
												: e.throw_error(A.error.type("character", n, r.indicator))
											: e.throw_error(A.error.type("character", t, r.indicator));
									},
									"op/3": function (e, t) {
										var n = t.args[0],
											i = t.args[1],
											a = t.args[2];
										if (A.type.is_variable(n) || A.type.is_variable(i) || A.type.is_variable(a))
											...
											if (A.type.is_atom(i))
												if (A.type.is_atom(a))
													if (n.value < 0 || n.value > 1200)
														e.throw_error(
															A.error.domain("operator_priority", n, t.indicator)
														);
													else if ("," === a.id)
														e.throw_error(
															A.error.permission("modify", "operator", a, t.indicator)
														);
													else if ("|" === a.id && (n.value < 1001 || 3 !== i.id.length))
														e.throw_error(
															A.error.permission("modify", "operator", a, t.indicator)
														);
													else if (
														-1 ===
														["fy", "fx", "yf", "xf", "xfx", "yfx", "xfy"].indexOf(i.id)
													)
														e.throw_error(
															A.error.domain("operator_specifier", i, t.indicator)
														);
													else {
														var s,
															...
															return (
																...
																n.value > 0 &&
																	...
																	e.session.__operators[n.value][a.id] ||
																		(e.session.__operators[n.value][a.id] = []),
																	e.session.__operators[n.value][a.id].push(i.id)),
																!0
															);
														e.throw_error(
															A.error.permission("create", "operator", a, t.indicator)
														);
													}
								...
								predicate: {
									...
									"current_op/3": function (e, r, t) {
										...
										for (var o in e.session.__operators)
											for (var p in e.session.__operators[o])
												for (var l = 0; l < e.session.__operators[o][p].length; l++)
													s.push(
														new P(
															r.goal.replace(
																new k(",", [
									...
									";/2": function (e, r, t) {
										if (A.type.is_term(t.args[0]) && "->/2" === t.args[0].indicator) {
											var n = e.points,
											...
											(e.session.format_success = function (e) {
												...
												(e.points = [new P(t.args[0].args[0], r.substitution, r)]);
											e.__calls.unshift(function (s) {
												(e.points = n),
													...
													!1 === s
														? e.prepend([
																new P(r.goal.replace(t.args[1]), r.substitution, r),
														  ])
														: A.type.is_error(s)
											...
											var s = new P(r.goal.replace(t.args[0]), r.substitution, r),
									...
									"!/0": function (e, r, t) {
										var n,
											i,
											a = [];
										for (n = r, i = null; null !== n.parent && n.parent.goal.search(t); )
										...
										for (var o = e.points.length - 1; o >= 0; o--) {
											for (var p = e.points[o], l = p.parent; null !== l && l !== n.parent; )
												l = l.parent;
									...
									"->/2": function (e, r, t) {
										var n = r.goal.replace(
											new k(",", [t.args[0], new k(",", [new k("!"), t.args[1]])])
										);
									...
									"once/1": function (e, r, t) {
										...
										e.prepend([
											new P(
												r.goal.replace(new k(",", [new k("call", [n]), new k("!", [])])),
												r.substitution,
												r
											),
										]);
									...
									"repeat/0": function (e, r, t) {
										e.prepend([new P(r.goal.replace(null), r.substitution, r), r]);
									},
									...
									"catch/3": function (e, r, t) {
										var n = e.points;
										(e.points = []), e.prepend([new P(t.args[0], r.substitution, r)]);
										...
										e.__calls.unshift(function (o) {
											...
											if (
												...
												e.points = l;
												var y = "true/0" === e.get_flag("occurs_check").indicator,
													_ = new P(),
												...
												for (u = p.length - 1; u >= 0; u--) {
													w.push(p[u]);
													var h = null !== p[u].goal ? p[u].goal.select() : null;
												...
												e.prepend(g),
													e.prepend(d),
													null === o && ((this.current_limit = 0), e.__calls.shift()(null));
											}
										});
									},
									"=/2": function (e, r, t) {
									...
									"subsumes_term/2": function (e, r, t) {
										...
										null !== i && t.args[1].apply(i).equals(t.args[1]) && e.success(r);
									},
									"findall/3": function (e, r, t) {
										var n = t.args[0],
											i = t.args[1],
											a = t.args[2];
										if (A.type.is_variable(i)) e.throw_error(A.error.instantiation(t.indicator));
										else if (A.type.is_callable(i))
													...
													y = function (t) {
														if (!1 === t || null === t || A.type.is_error(t)) {
															if (
																...
																for (var n = new k("[]"), i = c.length - 1; i >= 0; i--)
																	n = new k(".", [c[i], n]);
																e.prepend([
																	new P(
										...
										else e.throw_error(A.error.type("callable", i, t.indicator));
									},
									"bagof/3": function (e, t, n) {
										var i = n.args[0],
											a = n.args[1],
											s = n.args[2];
										if (A.type.is_variable(a)) e.throw_error(A.error.instantiation(n.indicator));
											...
											if (A.type.is_variable(s) || A.type.is_list(s)) {
												...
												for (
													...
													u = new k(".", [new x(l[c]), u]);
												var y = new k(",", [a, new k("=", [p, new k(",", [u, i])])]),
													_ = e.points,
													f = e.session.limit,
												...
												e.__calls.unshift(h);
											} else e.throw_error(A.error.type("list", s, n.indicator));
										else e.throw_error(A.error.type("callable", a, n.indicator));
									},
									...
									"functor/3": function (e, r, t) {
										...
										if (A.type.is_variable(n) && (A.type.is_variable(i) || A.type.is_variable(a)))
											...
											if (A.type.is_variable(i) || A.type.is_atomic(i))
												if (A.type.is_integer(i) && A.type.is_integer(a) && 0 !== a.value)
													e.throw_error(A.error.type("atom", t.args[1], "functor/3"));
													...
													var l = A.type.is_integer(n) ? n : new k(n.id, []),
														...
														c = new k(",", [new k("=", [l, i]), new k("=", [u, a])]);
													e.prepend([new P(r.goal.replace(c), r.substitution, r)]);
												}
											else e.throw_error(A.error.type("atomic", t.args[1], "functor/3"));
										else e.throw_error(A.error.type("integer", t.args[2], "functor/3"));
									},
									"arg/3": function (e, r, t) {
										if (A.type.is_variable(t.args[0]) || A.type.is_variable(t.args[1]))
											e.throw_error(A.error.instantiation(t.indicator));
										else if (t.args[0].value < 0)
											e.throw_error(A.error.domain("not_less_than_zero", t.args[0], t.indicator));
											...
											if (n > 0 && n <= t.args[1].args.length) {
												...
												e.prepend([new P(r.goal.replace(i), r.substitution, r)]);
											}
										} else e.throw_error(A.error.type("compound", t.args[1], t.indicator));
									},
									"=../2": function (e, r, t) {
										var n;
										if (
											...
											if (A.type.is_variable(t.args[0])) {
												if (!A.type.is_variable(t.args[1])) {
													...
													A.type.is_variable(t.args[0]) && A.type.is_variable(n)
														? e.throw_error(A.error.instantiation(t.indicator))
														: 0 === i.length && A.type.is_compound(t.args[1].args[0])
														? e.throw_error(
																A.error.type("atomic", t.args[1].args[0], t.indicator)
														  )
														: i.length > 0 &&
														  (A.type.is_compound(t.args[1].args[0]) ||
																A.type.is_number(t.args[1].args[0]))
														? e.throw_error(
																A.error.type("atom", t.args[1].args[0], t.indicator)
														  )
														: 0 === i.length
														? e.prepend([
																new P(
																	r.goal.replace(
																		new k("=", [t.args[1].args[0], t.args[0]], r)
																	),
																	r.substitution,
																	r
																),
										...
										else e.throw_error(A.error.type("list", t.args[1], t.indicator));
									},
									"copy_term/2": function (e, r, t) {
										var n = t.args[0].rename(e);
										e.prepend([
											new P(r.goal.replace(new k("=", [n, t.args[1]])), r.substitution, r.parent),
										]);
									},
									"term_variables/2": function (e, r, t) {
										...
										if (A.type.is_fully_list(a)) {
											...
											e.prepend([new P(r.goal.replace(new k("=", [a, s])), r.substitution, r)]);
										} else e.throw_error(A.error.type("list", a, t.indicator));
									},
									"clause/2": function (e, r, t) {
										if (A.type.is_variable(t.args[0]))
											...
											if (A.type.is_variable(t.args[1]) || A.type.is_callable(t.args[1])) {
												if (void 0 !== e.session.rules[t.args[0].indicator])
													if (e.is_public_predicate(t.args[0].indicator)) {
														...
														for (var i in e.session.rules[t.args[0].indicator])
															if (
																e.session.rules[t.args[0].indicator].hasOwnProperty(i)
															) {
																...
																n.push(new P(r.goal.replace(s), r.substitution, r));
															}
														e.prepend(n);
													} else
														e.throw_error(
											...
											} else e.throw_error(A.error.type("callable", t.args[1], t.indicator));
										else e.throw_error(A.error.type("callable", t.args[0], t.indicator));
									},
									"current_predicate/1": function (e, r, t) {
										var n = t.args[0];
										if (A.type.is_variable(n) || (A.type.is_compound(n) && "//2" === n.indicator))
											if (
												A.type.is_variable(n) ||
												...
												if (
													...
													for (var a in e.session.rules)
														if (e.session.rules.hasOwnProperty(a)) {
															var s = a.lastIndexOf("/"),
																o = a.substr(0, s),
																p = parseInt(a.substr(s + 1, a.length - (s + 1))),
																l = new k("/", [new k(o), new T(p, !1)]),
																u = new k("=", [l, n]);
															i.push(new P(r.goal.replace(u), r.substitution, r));
														}
													e.prepend(i);
												} else e.throw_error(A.error.type("integer", n.args[1], t.indicator));
											else e.throw_error(A.error.type("atom", n.args[0], t.indicator));
										else e.throw_error(A.error.type("predicate_indicator", n, t.indicator));
									},
													...
													? null === i || A.type.is_callable(i)
														? e.is_public_predicate(n.indicator)
															? (void 0 === e.session.rules[n.indicator] &&
															  ...
															  (e.session.rules[n.indicator] = [new C(n, i, !0)].concat(
																	e.session.rules[n.indicator]
															  )),
															  e.success(r))
															: e.throw_error(
													...
													? null === i || A.type.is_callable(i)
														? e.is_public_predicate(n.indicator)
															? (void 0 === e.session.rules[n.indicator] &&
																	(e.session.rules[n.indicator] = []),
															  (e.session.public_predicates[n.indicator] = !0),
															  e.session.rules[n.indicator].push(new C(n, i, !0)),
															  e.success(r))
															: e.throw_error(
																	A.error.permission(
																		"modify",
												...
												if (e.is_public_predicate(n.indicator)) {
													if (void 0 !== e.session.rules[n.indicator]) {
														for (
															...
															var l = "true/0" === e.get_flag("occurs_check").indicator;
															if (
																null !==
																A.unify(
																	new k(",", [n, i]),
									...
									"abolish/1": function (e, r, t) {
										if (
											...
											e.throw_error(A.error.instantiation(t.indicator));
										else if (A.type.is_term(t.args[0]) && "//2" === t.args[0].indicator)
											if (A.type.is_atom(t.args[0].args[0]))
												if (A.type.is_integer(t.args[0].args[1]))
													if (t.args[0].args[1].value < 0)
														...
														t.args[0].args[1].value > e.get_flag("max_arity").value
													)
														e.throw_error(A.error.representation("max_arity", t.indicator));
													else {
														var n = t.args[0].args[0].id + "/" + t.args[0].args[1].value;
													...
													e.throw_error(
														A.error.type("integer", t.args[0].args[1], t.indicator)
													);
											else e.throw_error(A.error.type("atom", t.args[0].args[0], t.indicator));
										else e.throw_error(A.error.type("predicate_indicator", t.args[0], t.indicator));
									},
									"atom_length/2": function (e, r, t) {
										if (A.type.is_variable(t.args[0]))
											e.throw_error(A.error.instantiation(t.indicator));
										else if (A.type.is_atom(t.args[0]))
											if (A.type.is_variable(t.args[1]) || A.type.is_integer(t.args[1]))
												if (A.type.is_integer(t.args[1]) && t.args[1].value < 0)
													e.throw_error(
														A.error.domain("not_less_than_zero", t.args[1], t.indicator)
													);
												else {
											...
											else e.throw_error(A.error.type("integer", t.args[1], t.indicator));
										else e.throw_error(A.error.type("atom", t.args[0], t.indicator));
									},
									"atom_concat/3": function (e, r, t) {
										var n,
											...
											s = t.args[1],
											o = t.args[2];
										if (A.type.is_variable(o) && (A.type.is_variable(a) || A.type.is_variable(s)))
											e.throw_error(A.error.instantiation(t.indicator));
											...
											if (A.type.is_variable(s) || A.type.is_atom(s))
												if (A.type.is_variable(o) || A.type.is_atom(o)) {
													...
													if (p || l)
														if (p && !l)
															(n = o.id.substr(0, o.id.length - s.id.length)) + s.id ===
																o.id &&
																((i = new k("=", [a, new k(n)])),
																e.prepend([
															...
															for (var u = [], c = 0; c <= o.id.length; c++) {
																...
																(i = new k(",", [
																	...
																	u.push(new P(r.goal.replace(i), r.substitution, r));
															}
															e.prepend(u);
														}
													else
														(i = new k("=", [o, new k(a.id + s.id)])),
															e.prepend([new P(r.goal.replace(i), r.substitution, r)]);
												} else e.throw_error(A.error.type("atom", o, t.indicator));
											...
											if (A.type.is_variable(o) || A.type.is_integer(o))
												if (A.type.is_variable(p) || A.type.is_integer(p))
													if (A.type.is_integer(s) && s.value < 0)
														e.throw_error(
															A.error.domain("not_less_than_zero", s, n.indicator)
														);
													else if (A.type.is_integer(o) && o.value < 0)
														e.throw_error(
															A.error.domain("not_less_than_zero", o, n.indicator)
														);
													else if (A.type.is_integer(p) && p.value < 0)
														e.throw_error(
															A.error.domain("not_less_than_zero", p, n.indicator)
														);
													else {
														var u = [],
															c = [],
												...
												else e.throw_error(A.error.type("integer", p, n.indicator));
											else e.throw_error(A.error.type("integer", o, n.indicator));
									...
									"atom_chars/2": function (e, r, t) {
										...
										if (A.type.is_variable(n) && A.type.is_variable(i))
											...
											if (A.type.is_variable(n)) {
												for (
													...
													if (A.type.is_character(a.args[0])) o += a.args[0].id;
														...
														if (!A.type.is_variable(a.args[0]))
															return void e.throw_error(
																A.error.type("character", a.args[0], t.indicator)
															);
													}
													a = a.args[1];
												}
												...
												for (var p = new k("[]"), l = n.id.length - 1; l >= 0; l--)
													p = new k(".", [new k(n.id.charAt(l)), p]);
												e.prepend([
													new P(r.goal.replace(new k("=", [i, p])), r.substitution, r),
												]);
											}
										...
										if (A.type.is_variable(n) && A.type.is_variable(i))
											...
											if (A.type.is_variable(n)) {
												for (
													...
													if (A.type.is_character_code(a.args[0])) l += o(a.args[0].value);
													else {
														...
														if (!A.type.is_variable(a.args[0]))
															return void e.throw_error(
																A.error.representation("character_code", t.indicator)
															);
													}
													a = a.args[1];
												}
												...
												for (var u = new k("[]"), c = n.id.length - 1; c >= 0; c--)
													u = new k(".", [new T(s(n.id, c), !1), u]);
												e.prepend([
													new P(r.goal.replace(new k("=", [i, u])), r.substitution, r),
												]);
											}
										else e.throw_error(A.error.type("atom", n, t.indicator));
									},
									"char_code/2": function (e, r, t) {
										...
										if (A.type.is_variable(n) && A.type.is_variable(i))
											...
											if (A.type.is_variable(i) || A.type.is_integer(i))
												if (A.type.is_variable(i) || A.type.is_character_code(i))
											...
											else e.throw_error(A.error.type("integer", i, t.indicator));
										else e.throw_error(A.error.type("character", n, t.indicator));
									},
											...
											if (A.type.is_variable(a) || A.type.is_list(a)) {
												...
												if (!A.type.is_variable(a)) {
													var o = a,
														p = !0;
													for (n = ""; "./2" === o.indicator; ) {
														if (A.type.is_character(o.args[0])) n += o.args[0].id;
														else if (A.type.is_variable(o.args[0])) p = !1;
														else if (!A.type.is_variable(o.args[0]))
															return void e.throw_error(
																A.error.type("character", o.args[0], t.indicator)
															);
														o = o.args[1];
													}
													if (
														...
														return void e.throw_error(A.error.type("list", a, t.indicator));
													if (!p && s)
														return void e.throw_error(A.error.instantiation(t.indicator));
													if (p) {
												...
												if (!s) {
													n = i.toString();
													for (var c = new k("[]"), y = n.length - 1; y >= 0; y--)
														c = new k(".", [new k(n.charAt(y)), c]);
													e.prepend([
														new P(r.goal.replace(new k("=", [a, c])), r.substitution, r),
													]);
												}
											} else e.throw_error(A.error.type("list", a, t.indicator));
									...
									"number_codes/2": function (e, r, t) {
										...
										if (A.type.is_variable(i) && A.type.is_variable(a))
											...
											if (A.type.is_variable(a) || A.type.is_list(a)) {
												...
												if (!A.type.is_variable(a)) {
													...
													for (n = ""; "./2" === l.indicator; ) {
														if (A.type.is_character_code(l.args[0]))
															...
															return void e.throw_error(
																A.error.type("character_code", l.args[0], t.indicator)
															);
														l = l.args[1];
													}
													if (
												...
												if (!p) {
													n = i.toString();
													for (var _ = new k("[]"), f = n.length - 1; f >= 0; f--)
														_ = new k(".", [new T(s(n, f), !1), _]);
													e.prepend([
														new P(r.goal.replace(new k("=", [a, _])), r.substitution, r),
													]);
												}
											} else e.throw_error(A.error.type("list", a, t.indicator));
										else e.throw_error(A.error.type("number", i, t.indicator));
									...
									"atomic_list_concat/2": function (e, r, t) {
										...
										e.prepend([
											new P(
												r.goal.replace(new k("atomic_list_concat", [n, new k("", []), i])),
												r.substitution,
												r
											),
										]);
									...
									"atomic_list_concat/3": function (e, r, t) {
										var n = t.args[0],
											a = t.args[1],
											s = t.args[2];
										if (A.type.is_variable(a) || (A.type.is_variable(n) && A.type.is_variable(s)))
											e.throw_error(A.error.instantiation(t.indicator));
											...
											if (A.type.is_variable(s) || A.type.is_atom(s))
												if (A.type.is_variable(s)) {
													for (
														...
														if (!A.type.is_atom(p.args[0]) && !A.type.is_number(p.args[0]))
															return void e.throw_error(
													...
													(o = new k(o, [])),
														A.type.is_variable(p)
															...
															: e.throw_error(A.error.type("list", n, t.indicator));
												} else {
													var l = g(
													...
													e.prepend([
														new P(r.goal.replace(new k("=", [l, n])), r.substitution, r),
													]);
												}
											else e.throw_error(A.error.type("atom", s, t.indicator));
									...
									"compare/3": function (e, r, t) {
										...
										if (A.type.is_variable(n) || A.type.is_atom(n))
											if (A.type.is_atom(n) && -1 === ["<", ">", "="].indexOf(n.id))
													...
													if (A.type.is_variable(a)) {
														...
														n.value < i.value &&
															s.push(
																new P(
																	r.goal.replace(
																		new k("between", [new T(n.value + 1, !1), i, a])
																	),
																	r.substitution,
																	r
																)
															...
															e.prepend(s);
													} else n.value <= a.value && i.value >= a.value && e.success(r);
												else e.throw_error(A.error.type("integer", a, t.indicator));
											else e.throw_error(A.error.type("integer", i, t.indicator));
										else e.throw_error(A.error.type("integer", n, t.indicator));
									},
										...
										A.type.is_variable(n) && A.type.is_variable(i)
											...
											? A.type.is_variable(i) || A.type.is_integer(i)
												? !A.type.is_variable(n) && n.value < 0
													? e.throw_error(
															A.error.domain("not_less_than_zero", n, t.indicator)
													  )
													: !A.type.is_variable(i) && i.value < 0
													? e.throw_error(
															A.error.domain("not_less_than_zero", i, t.indicator)
													  )
													: (A.type.is_variable(i) || i.value > 0) &&
													  (A.type.is_variable(n)
															? e.prepend([
									...
									"=:=/2": function (e, r, t) {
										...
										A.type.is_term(n) ? e.throw_error(n) : 0 === n && e.success(r);
									},
									"=\\=/2": function (e, r, t) {
										var n = A.arithmetic_compare(e, t.args[0], t.args[1]);
										A.type.is_term(n) ? e.throw_error(n) : 0 !== n && e.success(r);
									...
									"</2": function (e, r, t) {
										var n = A.arithmetic_compare(e, t.args[0], t.args[1]);
										A.type.is_term(n) ? e.throw_error(n) : n < 0 && e.success(r);
									},
									"=</2": function (e, r, t) {
										var n = A.arithmetic_compare(e, t.args[0], t.args[1]);
										A.type.is_term(n) ? e.throw_error(n) : n <= 0 && e.success(r);
									...
									"is_list/1": function (e, r, t) {
										for (var n = t.args[0]; A.type.is_term(n) && "./2" === n.indicator; )
											n = n.args[1];
										A.type.is_term(n) && "[]/0" === n.indicator && e.success(r);
									},
									"current_input/1": function (e, r, t) {
										var n = t.args[0];
										A.type.is_variable(n) || A.type.is_stream(n) || A.type.is_atom(n)
											? (A.type.is_atom(n) &&
													e.get_stream_by_alias(n.id) &&
													(n = e.get_stream_by_alias(n.id)),
											  e.prepend([
													new P(
														r.goal.replace(new k("=", [n, e.get_current_input()])),
														r.substitution,
														r
													),
											  ]))
									...
									"current_output/1": function (e, r, t) {
										...
										A.type.is_variable(n) || A.type.is_stream(n) || A.type.is_atom(n)
											? (A.type.is_atom(n) &&
											  ...
											  e.prepend([
													new P(
														r.goal.replace(new k("=", [n, e.get_current_output()])),
														r.substitution,
														r
													),
											  ]))
											: e.throw_error(A.error.domain("stream_or_alias", n, t.indicator));
									},
									"set_input/1": function (e, r, t) {
										...
										A.type.is_variable(n)
											...
											? A.type.is_stream(i)
												? !0 === i.output
													? e.throw_error(
															A.error.permission("input", "stream", n, t.indicator)
													  )
													: (e.set_current_input(i), e.success(r))
												: e.throw_error(A.error.existence("stream", n, t.indicator))
											: e.throw_error(A.error.domain("stream_or_alias", n, t.indicator));
									},
									"set_output/1": function (e, r, t) {
										...
										A.type.is_variable(n)
											...
											? A.type.is_stream(i)
												? !0 === i.input
													? e.throw_error(
															A.error.permission("output", "stream", n, t.indicator)
													  )
									...
									"open/3": function (e, r, t) {
										...
										e.prepend([
											new P(
												r.goal.replace(new k("open", [n, i, a, new k("[]", [])])),
												r.substitution,
												r
											),
										]);
											...
											if (A.type.is_list(s))
												if (A.type.is_variable(a))
													if (A.type.is_atom(n) || A.type.is_streamable(n))
														if (A.type.is_io_mode(i)) {
															for (
																...
																if (!A.type.is_stream_option(o))
																	return void e.throw_error(
																		A.error.domain("stream_option", o, t.indicator)
																	);
															...
															if (null === u)
																return void e.throw_error(
																	A.error.existence("source_sink", n, t.indicator)
																);
															var y = new O(
																u,
																i.id,
														...
														} else e.throw_error(A.error.domain("io_mode", i, t.indicator));
													else e.throw_error(A.error.domain("source_sink", n, t.indicator));
												else e.throw_error(A.error.type("variable", a, t.indicator));
											...
											if (A.type.is_stream(n) || A.type.is_atom(n))
												if (A.type.is_stream(a) && null !== a.stream) {
													for (
														...
														(o[s.id] = "true" === s.args[0].id), (p = p.args[1]);
													}
													if ("[]/0" !== p.indicator)
													...
													a === e.session.current_input
														? (e.session.current_input = e.session.standard_input)
														: a === e.session.current_output &&
														  (e.session.current_output = e.session.current_output),
														null !== a.alias
															? delete e.session.streams[a.alias]
															: delete e.session.streams[a.id],
														a.output && a.stream.flush();
													var l = a.stream.close();
													(a.stream = null), (!0 !== o.force && !0 !== l) || e.success(r);
												} else e.throw_error(A.error.existence("stream", n, t.indicator));
											else e.throw_error(A.error.domain("stream_or_alias", n, t.indicator));
									...
									"flush_output/1": function (e, r, t) {
										...
										A.type.is_variable(n)
											...
											? A.type.is_stream(i) && null !== i.stream
												? !0 === n.input
													? e.throw_error(
															A.error.permission("output", "stream", output, t.indicator)
													  )
									...
									"stream_property/2": function (e, r, t) {
										var n = t.args[0],
											i = t.args[1],
											a = A.type.is_stream(n) ? n : e.get_stream_by_alias(n.id);
										if (A.type.is_variable(n) || A.type.is_stream(n) || A.type.is_atom(n))
											if (A.type.is_variable(n) || (A.type.is_stream(a) && null !== a.stream))
												if (A.type.is_variable(i) || A.type.is_stream_property(i)) {
													var s = [],
														o = [];
													if (A.type.is_variable(n))
														for (var p in e.session.streams) s.push(e.session.streams[p]);
													else s.push(a);
													for (var l = 0; l < s.length; l++) {
														var u = [];
														s[l].filename &&
															u.push(new k("file_name", [new k(s[l].file_name, [])])),
															u.push(new k("mode", [new k(s[l].mode, [])])),
															u.push(new k(s[l].input ? "input" : "output", [])),
															s[l].alias &&
															...
															u.push(new k("eof_action", [new k(s[l].eof_action, [])])),
															u.push(
																new k("reposition", [
													...
													e.prepend(o);
												} else e.throw_error(A.error.domain("stream_property", i, t.indicator));
											else e.throw_error(A.error.existence("stream", n, t.indicator));
										else e.throw_error(A.error.domain("stream_or_alias", n, t.indicator));
									},
												...
												? A.type.is_stream_position(i)
													? !1 === a.reposition
														...
														: (A.type.is_integer(i)
																...
																: (a.position = i.id),
														  e.success(r))
													: e.throw_error(A.error.domain("stream_position", i, t.indicator))
												: e.throw_error(A.error.existence("stream", n, t.indicator))
											: e.throw_error(A.error.domain("stream_or_alias", n, t.indicator));
									},
									...
									"get_char/2": function (e, r, t) {
											...
											if (A.type.is_stream(n) || A.type.is_atom(n))
												if (A.type.is_stream(a) && null !== a.stream)
													if (a.output)
														...
														e.throw_error(
															A.error.permission("input", "binary_stream", n, t.indicator)
														);
													else if (
														...
														if ("end_of_stream" === a.position)
															(s = "end_of_file"), (a.position = "past_end_of_stream");
														else {
															if (null === (s = a.stream.get(1, a.position)))
																return void e.throw_error(
																	A.error.representation("character", t.indicator)
																);
															a.position++;
														}
														e.prepend([
										...
										else e.throw_error(A.error.type("in_character", i, t.indicator));
									},
									...
									"get_code/2": function (e, r, t) {
										...
										else e.throw_error(A.error.type("integer", char, t.indicator));
									},
												...
												? A.type.is_stream(a) && null !== a.stream
													? a.input
														...
														: a.stream.put(i.id, a.position) &&
														  ("number" == typeof a.position && a.position++, e.success(r))
													: e.throw_error(A.error.existence("stream", n, t.indicator))
												: e.throw_error(A.error.domain("stream_or_alias", n, t.indicator))
											: e.throw_error(A.error.type("character", i, t.indicator));
									},
											...
											? A.type.is_character_code(i)
												? A.type.is_variable(n) || A.type.is_stream(n) || A.type.is_atom(n)
													? A.type.is_stream(a) && null !== a.stream
														...
														: e.throw_error(A.error.existence("stream", n, t.indicator))
													: e.throw_error(A.error.domain("stream_or_alias", n, t.indicator))
												: e.throw_error(A.error.representation("character_code", t.indicator))
											: e.throw_error(A.error.type("integer", i, t.indicator));
									},
									"nl/0": function (e, r, t) {
										e.prepend([
									...
									"get_byte/2": function (e, r, t) {
											...
											if (A.type.is_stream(n) || A.type.is_atom(n))
												if (A.type.is_stream(a) && null !== a.stream)
													if (a.output)
														...
														e.throw_error(
															A.error.permission("input", "text_stream", n, t.indicator)
														);
													else if (
														"past_end_of_stream" === a.position &&
														"error" === a.eof_action
										...
										else e.throw_error(A.error.type("in_byte", char, t.indicator));
									},
											...
											if (A.type.is_stream(n) || A.type.is_atom(n))
												if (A.type.is_stream(a) && null !== a.stream)
													if (a.output)
														...
														if ("end_of_stream" === a.position)
															(s = "end_of_file"), (a.position = "past_end_of_stream");
														else if (null === (s = a.stream.get_byte(a.position)))
															return void e.throw_error(
																A.error.representation("byte", t.indicator)
															);
														e.prepend([
										...
										e.prepend([
											new P(
												r.goal.replace(
													new k(",", [
														new k("current_input", [new x("S")]),
														new k("read_term", [new x("S"), n, new k("[]", [])]),
													])
												),
												r.substitution,
												r
									...
									"read/2": function (e, r, t) {
										...
										e.prepend([
											new P(
												r.goal.replace(new k("read_term", [n, i, new k("[]", [])])),
												r.substitution,
												r
											),
										]);
													...
													if (o.output)
														...
														if ("[]/0" !== u.indicator)
															return void (A.type.is_variable(u)
																? e.throw_error(A.error.instantiation(t.indicator))
																: e.throw_error(A.error.type("list", s, t.indicator)));
														for (
															...
															(0 === _.type &&
																"token_not_found" ===
																	A.flatten_error(new k("throw", [_.value])).found);
															...
															if ("end_of_file" === c || "past_end_of_file" === c)
																return void (_
																	? e.throw_error(
																			A.error.syntax(
																				h[_.len - 1],
																	...
																	: e.throw_error(
																			A.error.syntax(null, "token not found", !0)
																	  ));
															o.position++,
																(w += c),
														...
														if (1 === _.type && _.len === h.length - 1 && "." === v.value) {
															...
															if (l.variable_names) {
																...
																b = new k(",", [b, new k("=", [l.variable_names, T])]);
															}
															if (l.singletons) {
																T = g(
																	i(
																...
																b = new k(",", [b, new k("=", [l.singletons, T])]);
															}
															e.prepend([new P(r.goal.replace(b), r.substitution, r)]);
														} else
															1 === _.type
																? e.throw_error(
																		A.error.syntax(h[_.len], "unexpected token", !1)
																  )
													...
													if (s.input)
														...
														for (
															...
															if (!A.type.is_write_option(o))
																return void e.throw_error(
																	A.error.domain("write_option", o, t.indicator)
																);
															(p[o.id] = "true" === o.args[0].id), (l = l.args[1]);
														}
														if ("[]/0" !== l.indicator)
															return void (A.type.is_variable(l)
																? e.throw_error(A.error.instantiation(t.indicator))
														...
														s.stream.put(u, s.position),
															"number" == typeof s.position && (s.position += u.length),
															e.success(r);
													}
												else e.throw_error(A.error.existence("stream", n, t.indicator));
											else e.throw_error(A.error.domain("stream_or_alias", n, t.indicator));
									...
									"current_prolog_flag/2": function (e, r, t) {
										...
										if (A.type.is_variable(n) || A.type.is_atom(n))
											if (A.type.is_variable(n) || A.type.is_flag(n)) {
												...
												e.prepend(a);
											} else e.throw_error(A.error.domain("prolog_flag", n, t.indicator));
										else e.throw_error(A.error.type("atom", n, t.indicator));
									},
											...
											? A.type.is_flag(n)
												? A.type.is_value_flag(n, i)
													? A.type.is_modifiable_flag(n)
														...
														: e.throw_error(A.error.permission("modify", "flag", n))
													: e.throw_error(
															A.error.domain(
																"flag_value",
																new k("+", [n, i]),
												...
												: e.throw_error(A.error.domain("prolog_flag", n, t.indicator))
											: e.throw_error(A.error.type("atom", n, t.indicator));
									},
								},
								flag: {
									...
									dialect: { allowed: [new k("tau")], value: new k("tau"), changeable: !1 },
									version_data: {
										allowed: [
											new k("tau", [
												new T(n.major, !1),
								...
								unify: function (e, r, t) {
									t = void 0 !== t && t;
									for (var n = [{ left: e, right: r }], i = {}; 0 !== n.length; ) {
										var a = n.pop();
										if (((e = a.left), (r = a.right), A.type.is_term(e) && A.type.is_term(r))) {
											...
											if (e.value !== r.value || e.is_float !== r.is_float) return null;
										} else if (A.type.is_variable(e)) {
											if (A.type.is_variable(r) && e.id === r.id) continue;
											if (!0 === t && -1 !== r.variables().indexOf(e.id)) return null;
											if ("_" !== e.id) {
												var o = new E();
												o.add(e.id, r);
										...
										} else if (A.type.is_variable(r)) n.push({ left: r, right: e });
										else {
								...
								operate: function (e, r) {
									if (A.type.is_operator(r)) {
										for (
											...
											if (((t = r.args[s].interpret(e)), !A.type.is_number(t))) return t;
										...
										return (
											i.push(e),
											(t = A.arithmetic.evaluation[r.indicator].fn.apply(this, i)),
									...
									return A.error.type("evaluable", r.indicator, e.__call_indicator);
								},
								error: {
									existence: function (e, r, t) {
										return (
											"string" == typeof r && (r = b(r)),
											new k("error", [new k("existence_error", [new k(e), r]), b(t)])
										);
									},
									type: function (e, r, t) {
										return new k("error", [new k("type_error", [new k(e), r]), b(t)]);
									},
									instantiation: function (e) {
										return new k("error", [new k("instantiation_error"), b(e)]);
									},
									domain: function (e, r, t) {
										return new k("error", [new k("domain_error", [new k(e), r]), b(t)]);
									},
									representation: function (e, r) {
										return new k("error", [new k("representation_error", [new k(e)]), b(r)]);
									},
									...
									evaluation: function (e, r) {
										return new k("error", [new k("evaluation_error", [new k(e)]), b(r)]);
									},
									syntax: function (e, r, t) {
										e = e || { value: "", line: 0, column: 0, matches: [""], start: 0 };
										var n = t && e.matches.length > 0 ? e.start + e.matches[0].length : e.start,
											i = t
										...
										return new k("error", [new k("syntax_error", [new k(r)]), a]);
									},
									syntax_by_predicate: function (e, r) {
										return new k("error", [new k("syntax_error", [new k(e)]), b(r)]);
									},
								},
								warning: {
								...
								format_answer: function (e, r, t) {
									...
									if (A.type.is_substitution(e)) {
										...
										e = e.filter(function (e, r) {
											return !A.type.is_variable(r) || (-1 !== a.indexOf(r.id) && e !== r.id);
										});
									}
								...
								flatten_error: function (e) {
									...
									return (
										(r.type = e.args[0].id),
										(r.thrown = "syntax_error" === r.type ? null : e.args[1].id),
										(r.expected = null),
										(r.found = null),
							...
							e.exports = function (e) {
								new (r = e).type.Module(
									"lists",
									{
										"append/2": [
											new r.type.Rule(
												new r.type.Term("append", [new r.type.Var("X"), new r.type.Var("L")]),
										...
										"append/3": [
											...
											new r.type.Rule(
												new r.type.Term("append", [
													new r.type.Term(".", [new r.type.Var("H"), new r.type.Var("T")]),
													new r.type.Var("X"),
													new r.type.Term(".", [new r.type.Var("H"), new r.type.Var("S")]),
												]),
												new r.type.Term("append", [
													new r.type.Var("T"),
													new r.type.Var("X"),
										...
										"member/2": [
											new r.type.Rule(
												new r.type.Term("member", [
													new r.type.Var("X"),
													new r.type.Term(".", [new r.type.Var("X"), new r.type.Var("_")]),
												]),
												null
											),
											new r.type.Rule(
												new r.type.Term("member", [
													new r.type.Var("X"),
													new r.type.Term(".", [new r.type.Var("_"), new r.type.Var("Xs")]),
												]),
												new r.type.Term("member", [new r.type.Var("X"), new r.type.Var("Xs")])
											),
										],
										"permutation/2": [
											new r.type.Rule(
										...
										"maplist/2": [
											...
											new r.type.Rule(
												new r.type.Term("maplist", [
													new r.type.Var("P"),
													new r.type.Term(".", [new r.type.Var("X"), new r.type.Var("Xs")]),
												]),
												new r.type.Term(",", [
													new r.type.Term("call", [new r.type.Var("P"), new r.type.Var("X")]),
													new r.type.Term("maplist", [
														new r.type.Var("P"),
														new r.type.Var("Xs"),
													]),
										...
										"maplist/3": [
											...
											new r.type.Rule(
												new r.type.Term("maplist", [
													new r.type.Var("P"),
													new r.type.Term(".", [new r.type.Var("A"), new r.type.Var("As")]),
													new r.type.Term(".", [new r.type.Var("B"), new r.type.Var("Bs")]),
												]),
												new r.type.Term(",", [
										...
										"maplist/4": [
											...
											new r.type.Rule(
												new r.type.Term("maplist", [
													...
													new r.type.Term(".", [new r.type.Var("A"), new r.type.Var("As")]),
													new r.type.Term(".", [new r.type.Var("B"), new r.type.Var("Bs")]),
													new r.type.Term(".", [new r.type.Var("C"), new r.type.Var("Cs")]),
												]),
												new r.type.Term(",", [
													new r.type.Term("call", [
														new r.type.Var("P"),
										...
										"maplist/5": [
											...
											new r.type.Rule(
												new r.type.Term("maplist", [
													...
													new r.type.Term(".", [new r.type.Var("B"), new r.type.Var("Bs")]),
													new r.type.Term(".", [new r.type.Var("C"), new r.type.Var("Cs")]),
													new r.type.Term(".", [new r.type.Var("D"), new r.type.Var("Ds")]),
												]),
												new r.type.Term(",", [
													new r.type.Term("call", [
														new r.type.Var("P"),
										...
										"maplist/6": [
											...
											new r.type.Rule(
												new r.type.Term("maplist", [
													...
													new r.type.Term(".", [new r.type.Var("C"), new r.type.Var("Cs")]),
													new r.type.Term(".", [new r.type.Var("D"), new r.type.Var("Ds")]),
													new r.type.Term(".", [new r.type.Var("E"), new r.type.Var("Es")]),
												]),
												new r.type.Term(",", [
													new r.type.Term("call", [
														new r.type.Var("P"),
										...
										"maplist/7": [
											...
											new r.type.Rule(
												new r.type.Term("maplist", [
													...
													new r.type.Term(".", [new r.type.Var("D"), new r.type.Var("Ds")]),
													new r.type.Term(".", [new r.type.Var("E"), new r.type.Var("Es")]),
													new r.type.Term(".", [new r.type.Var("F"), new r.type.Var("Fs")]),
												]),
												new r.type.Term(",", [
													new r.type.Term("call", [
														new r.type.Var("P"),
										...
										"maplist/8": [
											...
											new r.type.Rule(
												new r.type.Term("maplist", [
													...
													new r.type.Term(".", [new r.type.Var("E"), new r.type.Var("Es")]),
													new r.type.Term(".", [new r.type.Var("F"), new r.type.Var("Fs")]),
													new r.type.Term(".", [new r.type.Var("G"), new r.type.Var("Gs")]),
												]),
												new r.type.Term(",", [
													new r.type.Term("call", [
														new r.type.Var("P"),
										...
										"include/3": [
											...
											new r.type.Rule(
												...
												new r.type.Term(",", [
													new r.type.Term("=..", [new r.type.Var("P"), new r.type.Var("A")]),
													new r.type.Term(",", [
														new r.type.Term("append", [
															new r.type.Var("A"),
															new r.type.Term(".", [
														...
														new r.type.Term(",", [
															...
															new r.type.Term(",", [
																new r.type.Term(";", [
																	new r.type.Term(",", [
																		new r.type.Term("call", [new r.type.Var("F")]),
																		new r.type.Term(",", [
																			new r.type.Term("=", [
																				new r.type.Var("L"),
																				new r.type.Term(".", [
													...
													new r.type.Term(",", [
														...
														new r.type.Term(",", [
															...
															new r.type.Term(",", [
																...
																new r.type.Term(";", [
																	new r.type.Term(",", [
																		new r.type.Term("call", [new r.type.Var("R")]),
																		new r.type.Term(",", [
																			new r.type.Term("!", []),
																			new r.type.Term("=", [
																				new r.type.Var("S"),
										...
										"foldl/4": [
											...
											new r.type.Rule(
												...
												new r.type.Term(",", [
													new r.type.Term("=..", [new r.type.Var("P"), new r.type.Var("L")]),
													new r.type.Term(",", [
														new r.type.Term("append", [
															new r.type.Var("L"),
															new r.type.Term(".", [
										...
										"select/3": [
											new r.type.Rule(
												new r.type.Term("select", [
													new r.type.Var("E"),
													new r.type.Term(".", [new r.type.Var("E"), new r.type.Var("Xs")]),
													new r.type.Var("Xs"),
												]),
												null
											),
											new r.type.Rule(
												new r.type.Term("select", [
													new r.type.Var("E"),
													new r.type.Term(".", [new r.type.Var("X"), new r.type.Var("Xs")]),
													new r.type.Term(".", [new r.type.Var("X"), new r.type.Var("Ys")]),
												]),
												new r.type.Term("select", [
													new r.type.Var("E"),
													new r.type.Var("Xs"),
										...
										"last/2": [
											...
											new r.type.Rule(
												...
												new r.type.Term("last", [new r.type.Var("Xs"), new r.type.Var("X")])
											),
										],
										"prefix/2": [
											new r.type.Rule(
										...
										"length/2": function (e, t, n) {
											...
											if (r.type.is_variable(a) || r.type.is_integer(a))
												if (r.type.is_integer(a) && a.value < 0)
													e.throw_error(r.error.domain("not_less_than_zero", a, n.indicator));
												else {
													var s = new r.type.Term("length", [i, new r.type.Num(0, !1), a]);
													r.type.is_integer(a) &&
														(s = new r.type.Term(",", [s, new r.type.Term("!", [])])),
														e.prepend([
															new r.type.State(t.goal.replace(s), t.substitution, t),
														]);
												}
										...
										"length/3": [
											...
											new r.type.Rule(
												new r.type.Term("length", [
													new r.type.Term(".", [new r.type.Var("_"), new r.type.Var("X")]),
													new r.type.Var("A"),
													new r.type.Var("N"),
												]),
												new r.type.Term(",", [
													new r.type.Term("succ", [new r.type.Var("A"), new r.type.Var("B")]),
													new r.type.Term("length", [
														new r.type.Var("X"),
														new r.type.Var("B"),
														new r.type.Var("N"),
										...
										"replicate/3": function (e, t, n) {
											...
											if (r.type.is_variable(a))
												...
												if (a.value < 0)
													...
													for (var o = new r.type.Term("[]"), p = 0; p < a.value; p++)
												...
												} else e.throw_error(r.error.type("list", s, n.indicator));
											else e.throw_error(r.error.type("integer", a, n.indicator));
										},
											...
											if (r.type.is_variable(i))
												...
												for (var s, o = [], p = i; "./2" === p.indicator; ) {
													if (((s = p.args[0]), r.type.is_variable(s)))
														return void e.throw_error(r.error.instantiation(n.indicator));
													if (!r.type.is_term(s) || "-/2" !== s.indicator)
														return void e.throw_error(r.error.type("pair", s, n.indicator));
													(s.args[0].pair = s.args[1]), o.push(s.args[0]), (p = p.args[1]);
												}
												...
												if (r.type.is_variable(a) || r.type.is_fully_list(a))
													if (s || o) {
														for (
															...
															(l = new r.type.Term(".", [p.args[0], l])), (p = p.args[1]);
														e.prepend([
															new r.type.State(
																t.goal.replace(new r.type.Term("=", [l, s ? a : i])),
																t.substitution,
																t
															),
														]);
													} else e.throw_error(r.error.instantiation(n.indicator));
												else e.throw_error(r.error.type("list", a, n.indicator));
											else e.throw_error(r.error.type("list", i, n.indicator));
										},
